...
Now, to start sending traces from Venus-Miner to Jaeger, set the environment variable `SOPHON_MINER_JAEGER` to `localhost:6831`, and start the `sophon-miner run`.
