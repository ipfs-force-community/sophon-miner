...
func (b *Blockstore) lockMove() { //nolint
	b.moveMx.Lock()
...
func (b *Blockstore) unlockMove(state bsMoveState) { //nolint
	b.moveState = state
	b.moveCond.Broadcast()
	b.moveMx.Unlock()
}
...
func (b *Blockstore) movingGC() error { //nolint
...
func symlink(path, linkTo string) error { //nolint
...
func (b *Blockstore) doCopy(from, to *badger.DB) error { //nolint
...
func (b *Blockstore) deleteDB(path string) { //nolint
...
func (b *Blockstore) onlineGC() error { //nolint
	b.lockDB()
	defer b.unlockDB()
